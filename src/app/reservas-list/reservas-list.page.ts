...
import { IonContent, IonHeader, IonTitle, IonToolbar, AlertController, IonButtons, IonMenuButton, IonItem, IonText, IonLabel } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonLabel, IonItem, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, IonButtons, IonMenuButton, IonText]
})
